...
class CodeRunnerApp:
    ...
    def create_start_interface(self):
        ...
        title_label = ttk.Label(self.root, text="GESTURELINK ACCESSIBILE INTERFACE", font=("Arial", 18, "bold"))
    ...
    def show_main_interface(self):
        ...
        self.root.geometry("800x600")  # Increased size
        self.script_names = {
            "HAND CONTROL": r"C:\Users\shinchan\OneDrive\Documents\NANOTHON 2.0\LED Controller\LED Controller\main.py",
            ...
            "VIRTUAL CANVAS": r"C:\Users\shinchan\OneDrive\Documents\NANOTHON 2.0\DIGITAL_BOARD_CANVAS\Air-Canvas-with-ML-master\air_canvas_ml.py",
            "VIRTUAL KEYBOARD": r"C:\Users\shinchan\OneDrive\Documents\NANOTHON 2.0\Virtual-Keyboard-using-Python-main\Virtual-Keyboard-using-Python-main\virtual_keyboard.py",
        }
        ...
        indications_label = ttk.Label(self.root, text="*  Click on the button to run the operation\n"
                                                    ...
                                                    "*  MADE WITH  ❤️ QUINTET", font=("Times New Roman", 10, "bold"), background="sky blue")
